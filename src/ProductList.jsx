    ...
    return (
        <div>
            ...
            <div className="tag">
               ...
               <img src="https://cdn.pixabay.com/photo/2017/06/27/18/22/sunflowers-2448351_960_720.png" alt="" />
               <a href="/" style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>Green Nature</h3>
                    <i style={{color:'white'}}>See the beauty of Nature</i>
                    </div>
                    </a>
                </div>
